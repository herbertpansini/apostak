...
public class ConfirmacaoAdapter extends BaseAdapter implements Filterable {
    ...
    public ConfirmacaoAdapter(Context context, ArrayList<UsuarioAposta> usuarioApostas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.confirmacao_item, parent, false);
            ...
            holder.imgConfirm = (ImageView) convertView.findViewById(R.id.imgConfirm);
        ...
        holder.imgConfirm.setImageResource(R.drawable.checked);
