package com.lacerda.thiago.apostak;
...
import com.lacerda.thiago.adapters.UsuarioApostaAdapter;
...
public class ConfirmacaoFragment extends ListFragment implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {
    ArrayList<UsuarioAposta> mUsuarioApostas;
    private UsuarioApostaAdapter mAdapter;
    private Context mContext;

    private final int IS_VALID = 1;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_refresh:
                String url = getResources().getString(R.string.default_url) + "pendente/";
                new MyTaskAsync().execute(url + IS_VALID);
                break;
            default:
                break;
        }
    ...
    private class MyTaskAsync extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            JSONObject json = jsonParser.getJSONFromUrl(mUrl+ IS_VALID);
            return json;
        }
        ...
        protected void onPostExecute(JSONObject json) {
            if (json != null) {
                ...
                if (mUsuarioApostas.size() > 0) {
                    ...
                    usuarioAposta.setNome("Aposta(s) Confirmada(s): ");
