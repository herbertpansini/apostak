...
import com.lacerda.thiago.entities.ReportHeader;
    ...
    private void displaySelectedScreen(int id) {
        ...
        switch (id) {
            case R.id.navigation_home :
                ...
                ((AppCompatActivity)MainActivity.this).getSupportActionBar().setTitle("Brasileirão Série A");
                break;
            ...
            case R.id.nav_Rodadas :
                ...
                ((AppCompatActivity)MainActivity.this).getSupportActionBar().setTitle("Rodadas do Brasileirão");
                break;
