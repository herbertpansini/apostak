...
public class HomeFragment extends ListFragment implements SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {
    ...
    private void populateList() {
        ...
        mAllValues.add("Washington D.C");
        mAllValues.add("London");
        mAllValues.add("Madrid");
        mAllValues.add("Ciudad de México");
        mAllValues.add("Lima");
        mAllValues.add("Santiago");
        mAllValues.add("Buenos Aires");
        mAllValues.add("Cacaras");
        mAllValues.add("Bogotá");
        mAllValues.add("Montevideo");
        mAllValues.add("Asunción");
        mAllValues.add("La Paz");
