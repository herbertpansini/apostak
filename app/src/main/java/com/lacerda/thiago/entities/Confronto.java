package com.lacerda.thiago.entities;
...
public class Confronto implements Serializable {
    ...
    public Confronto(int rodada, int equipeMandante, Integer placarEquipeMandante, Integer placarEquipeVisitante, int equipeVisitante, Date horario) {
    ...
    public Confronto(int id, int rodada, int equipeMandante, Integer placarEquipeMandante, Integer placarEquipeVisitante, int equipeVisitante, Date horario) {
        this.setId(id);
        this.setRodada(rodada);
        this.setEquipeMandante(equipeMandante);
        this.setPlacarEquipeMandante(placarEquipeMandante);
